...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($email)) {
        ...
        if (!$user) {
            ...
            $pdo->exec("
                CREATE TABLE IF NOT EXISTS password_resets_client (
            ...
            $stmtToken = $pdo->prepare("INSERT INTO password_resets_client (user_id, token, expires_at) VALUES (?, ?, ?)");
            ...
            try {
                ...
                $mail->Body = "
                    ...
                    <a href='http://localhost/avocat-client/coding/reinitialiser_mdp_client.php?token=$token'>Réinitialiser mon mot de passe</a><br><br>
            ...
            <div class="col-lg-8">
                <div class="password-container">
                    <div class="password-header">
                        <i class="fas fa-user-lock legal-icon client-icon"></i>
                        <h1 class="h3 mb-0">Mot de passe oublié - Client</h1>
                    ...
                    <div class="password-body">
                        ...
                        <form method="POST" class="row g-3">
                            <div class="col-12">
                                <p class="text-muted mb-3">Saisissez votre adresse email associée à votre compte client. Nous vous enverrons un lien pour réinitialiser votre mot de passe.</p>
                            </div>
                        ...
                        <div class="text-center mt-4">
                            <p>Vous vous souvenez de votre mot de passe ? <a href="connexion_client.php" class="login-link">Connectez-vous ici</a></p>
                            <p>Vous êtes un avocat ? <a href="mot_de_passe_oublie.php" class="login-link">Réinitialiser le mot de passe avocat</a></p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-md-4 mb-3">
                            <div class="step-card">
                                ...
                                <p class="small mb-0">Entrez l'adresse email associée à votre compte client</p>
                            </div>
                        </div>
                        <div class="col-md-4 mb-3">
                            <div class="step-card">
